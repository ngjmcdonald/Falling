...
HX_STACK_PUSH("ByteArray::__init__","flash/utils/ByteArray.hx",699);
{

	HX_BEGIN_LOCAL_FUNC_S0(hx::LocalFunc,_Function_1_1)
	::flash::utils::ByteArray run(int length){
		HX_STACK_PUSH("*::_Function_1_1","flash/utils/ByteArray.hx",701);
	...
	Void run(::flash::utils::ByteArray bytes,int length){
		HX_STACK_PUSH("*::_Function_1_2","flash/utils/ByteArray.hx",702);
	...
	Array< unsigned char > run(::flash::utils::ByteArray bytes){
		HX_STACK_PUSH("*::_Function_1_3","flash/utils/ByteArray.hx",714);
		HX_STACK_ARG(bytes,"bytes");
		{
			HX_STACK_LINE(714)
	...
	int run(::flash::utils::ByteArray bytes1){
		HX_STACK_PUSH("*::_Function_1_4","flash/utils/ByteArray.hx",715);
...
::String ByteArray_obj::set_endian( ::String value){
	HX_STACK_PUSH("ByteArray::set_endian","flash/utils/ByteArray.hx",754);
	HX_STACK_THIS(this);
...
::String ByteArray_obj::get_endian( ){
	HX_STACK_PUSH("ByteArray::get_endian","flash/utils/ByteArray.hx",753);
	HX_STACK_THIS(this);
	HX_STACK_LINE(753)
...
int ByteArray_obj::get_byteLength( ){
	HX_STACK_PUSH("ByteArray::get_byteLength","flash/utils/ByteArray.hx",752);
	HX_STACK_THIS(this);
	HX_STACK_LINE(752)
	return this->length;
}
...
int ByteArray_obj::get_bytesAvailable( ){
	HX_STACK_PUSH("ByteArray::get_bytesAvailable","flash/utils/ByteArray.hx",751);
	HX_STACK_THIS(this);
	HX_STACK_LINE(751)
...
int ByteArray_obj::__throwEOFi( ){
	HX_STACK_PUSH("ByteArray::__throwEOFi","flash/utils/ByteArray.hx",736);
	HX_STACK_THIS(this);
	HX_STACK_LINE(738)
...
{
		HX_STACK_PUSH("ByteArray::__set","flash/utils/ByteArray.hx",725);
		HX_STACK_THIS(this);
...
int ByteArray_obj::__get( int pos){
	HX_STACK_PUSH("ByteArray::__get","flash/utils/ByteArray.hx",686);
	HX_STACK_THIS(this);
	HX_STACK_ARG(pos,"pos");
	HX_STACK_LINE(686)
...
{
		HX_STACK_PUSH("ByteArray::__fromBytes","flash/utils/ByteArray.hx",674);
		HX_STACK_THIS(this);
		HX_STACK_ARG(bytes,"bytes");
		HX_STACK_LINE(676)
		this->b = bytes->b;
...
{
		HX_STACK_PUSH("ByteArray::writeUTFBytes","flash/utils/ByteArray.hx",661);
		HX_STACK_THIS(this);
		HX_STACK_ARG(s,"s");
		HX_STACK_LINE(666)
...
{
		HX_STACK_PUSH("ByteArray::writeUTF","flash/utils/ByteArray.hx",647);
		HX_STACK_THIS(this);
		HX_STACK_ARG(s,"s");
		HX_STACK_LINE(652)
		::haxe::io::Bytes bytes = ::haxe::io::Bytes_obj::ofString(s);		HX_STACK_VAR(bytes,"bytes");
...
{
		HX_STACK_PUSH("ByteArray::writeUnsignedInt","flash/utils/ByteArray.hx",640);
		HX_STACK_THIS(this);
		HX_STACK_ARG(value,"value");
		HX_STACK_LINE(640)
		this->writeInt(value);
...
{
		HX_STACK_PUSH("ByteArray::writeShort","flash/utils/ByteArray.hx",621);
		HX_STACK_THIS(this);
		HX_STACK_ARG(value,"value");
		HX_STACK_LINE(623)
...
{
		HX_STACK_PUSH("ByteArray::writeInt","flash/utils/ByteArray.hx",598);
		HX_STACK_THIS(this);
		HX_STACK_ARG(value,"value");
		HX_STACK_LINE(600)
...
{
		HX_STACK_PUSH("ByteArray::writeFloat","flash/utils/ByteArray.hx",585);
		HX_STACK_THIS(this);
		HX_STACK_ARG(x,"x");
		HX_STACK_LINE(590)
...
{
		HX_STACK_PUSH("ByteArray::writeFile","flash/utils/ByteArray.hx",576);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("ByteArray::writeDouble","flash/utils/ByteArray.hx",561);
		HX_STACK_THIS(this);
		HX_STACK_ARG(x,"x");
		HX_STACK_LINE(566)
...
int length = __o_length.Default(0);
	HX_STACK_PUSH("ByteArray::writeBytes","flash/utils/ByteArray.hx",550);
	HX_STACK_THIS(this);
	HX_STACK_ARG(bytes,"bytes");
...
{
		HX_STACK_PUSH("ByteArray::writeByte","flash/utils/ByteArray.hx",537);
		HX_STACK_THIS(this);
		HX_STACK_ARG(value,"value");
		HX_STACK_LINE(539)
...
{
		HX_STACK_PUSH("ByteArray::writeBoolean","flash/utils/ByteArray.hx",530);
		HX_STACK_THIS(this);
		HX_STACK_ARG(value,"value");
		HX_STACK_LINE(532)
		this->ensureElem(this->position,true);
...
{
		HX_STACK_PUSH("ByteArray::write_uncheck","flash/utils/ByteArray.hx",519);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("ByteArray::uncompress","flash/utils/ByteArray.hx",475);
		HX_STACK_THIS(this);
		...
		if (((algorithm == ::flash::utils::CompressionAlgorithm_obj::LZMA))){
			...
			struct _Function_2_1{
				inline static int Block( ::flash::utils::CompressionAlgorithm &algorithm){
					HX_STACK_PUSH("*::closure","flash/utils/ByteArray.hx",493);
					{
						HX_STACK_LINE(493)
						{
...
::flash::utils::ByteArray ByteArray_obj::slice( int begin,Dynamic end){
	HX_STACK_PUSH("ByteArray::slice","flash/utils/ByteArray.hx",427);
	HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("ByteArray::setLength","flash/utils/ByteArray.hx",414);
		HX_STACK_THIS(this);
		HX_STACK_ARG(length,"length");
		HX_STACK_LINE(416)
		if (((length > (int)0))){
