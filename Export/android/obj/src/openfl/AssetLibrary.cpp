...
{
HX_STACK_PUSH("AssetLibrary::new","openfl/Assets.hx",908);
{
}
;
	return null();
...
{
		HX_STACK_PUSH("AssetLibrary::loadSound","openfl/Assets.hx",1006);
		HX_STACK_THIS(this);
		HX_STACK_ARG(id,"id");
...
{
		HX_STACK_PUSH("AssetLibrary::loadMovieClip","openfl/Assets.hx",999);
		HX_STACK_THIS(this);
		HX_STACK_ARG(id,"id");
		HX_STACK_ARG(handler,"handler");
		HX_STACK_LINE(999)
...
{
		HX_STACK_PUSH("AssetLibrary::loadFont","openfl/Assets.hx",992);
		HX_STACK_THIS(this);
		HX_STACK_ARG(id,"id");
		HX_STACK_ARG(handler,"handler");
		HX_STACK_LINE(992)
...
{
		HX_STACK_PUSH("AssetLibrary::loadBytes","openfl/Assets.hx",985);
		HX_STACK_THIS(this);
		HX_STACK_ARG(id,"id");
		HX_STACK_ARG(handler,"handler");
		HX_STACK_LINE(985)
...
{
		HX_STACK_PUSH("AssetLibrary::loadBitmapData","openfl/Assets.hx",978);
		HX_STACK_THIS(this);
		HX_STACK_ARG(id,"id");
		HX_STACK_ARG(handler,"handler");
		HX_STACK_LINE(978)
...
{
		HX_STACK_PUSH("AssetLibrary::load","openfl/Assets.hx",971);
		HX_STACK_THIS(this);
		HX_STACK_ARG(handler,"handler");
		HX_STACK_LINE(971)
...
bool AssetLibrary_obj::isLocal( ::String id,::openfl::AssetType type){
	HX_STACK_PUSH("AssetLibrary::isLocal","openfl/Assets.hx",964);
	HX_STACK_THIS(this);
	HX_STACK_ARG(id,"id");
...
::flash::media::Sound AssetLibrary_obj::getSound( ::String id){
	HX_STACK_PUSH("AssetLibrary::getSound","openfl/Assets.hx",957);
	HX_STACK_THIS(this);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(957)
	return null();
...
::String AssetLibrary_obj::getPath( ::String id){
	HX_STACK_PUSH("AssetLibrary::getPath","openfl/Assets.hx",950);
	HX_STACK_THIS(this);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(950)
	return null();
...
::flash::display::MovieClip AssetLibrary_obj::getMovieClip( ::String id){
	HX_STACK_PUSH("AssetLibrary::getMovieClip","openfl/Assets.hx",943);
	HX_STACK_THIS(this);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(943)
	return null();
...
::flash::text::Font AssetLibrary_obj::getFont( ::String id){
	HX_STACK_PUSH("AssetLibrary::getFont","openfl/Assets.hx",936);
	HX_STACK_THIS(this);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(936)
	return null();
...
::flash::utils::ByteArray AssetLibrary_obj::getBytes( ::String id){
	HX_STACK_PUSH("AssetLibrary::getBytes","openfl/Assets.hx",929);
	HX_STACK_THIS(this);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(929)
	return null();
...
::flash::display::BitmapData AssetLibrary_obj::getBitmapData( ::String id){
	HX_STACK_PUSH("AssetLibrary::getBitmapData","openfl/Assets.hx",922);
	HX_STACK_THIS(this);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(922)
	return null();
...
bool AssetLibrary_obj::exists( ::String id,::openfl::AssetType type){
	HX_STACK_PUSH("AssetLibrary::exists","openfl/Assets.hx",915);
	HX_STACK_THIS(this);
	HX_STACK_ARG(id,"id");
	HX_STACK_ARG(type,"type");
	HX_STACK_LINE(915)
