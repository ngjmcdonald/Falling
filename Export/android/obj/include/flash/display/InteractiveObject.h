...
class HXCPP_CLASS_ATTRIBUTES  InteractiveObject_obj : public ::flash::display::DisplayObject_obj{
	...
	public:
		...
		static Dynamic nme_display_object_dismiss_soft_keyboard;
		static Dynamic &nme_display_object_dismiss_soft_keyboard_dyn() { return nme_display_object_dismiss_soft_keyboard;}
