...
{
HX_STACK_PUSH("Listener::new","flash/events/EventDispatcher.hx",254);
{
	HX_STACK_LINE(256)
...
bool Listener_obj::is( Dynamic listener,bool useCapture){
	HX_STACK_PUSH("Listener::is","flash/events/EventDispatcher.hx",271);
	HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Listener::dispatchEvent","flash/events/EventDispatcher.hx",264);
		HX_STACK_THIS(this);
