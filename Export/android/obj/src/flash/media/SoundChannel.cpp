...
::flash::media::SoundTransform SoundChannel_obj::set_soundTransform( ::flash::media::SoundTransform value){
	HX_STACK_PUSH("SoundChannel::set_soundTransform","flash/media/SoundChannel.hx",169);
	HX_STACK_THIS(this);
...
::flash::media::SoundTransform SoundChannel_obj::get_soundTransform( ){
	HX_STACK_PUSH("SoundChannel::get_soundTransform","flash/media/SoundChannel.hx",156);
	HX_STACK_THIS(this);
	HX_STACK_LINE(158)
...
Float SoundChannel_obj::set_position( Float value){
	HX_STACK_PUSH("SoundChannel::set_position","flash/media/SoundChannel.hx",153);
	HX_STACK_THIS(this);
	HX_STACK_ARG(value,"value");
	HX_STACK_LINE(153)
...
Float SoundChannel_obj::get_position( ){
	HX_STACK_PUSH("SoundChannel::get_position","flash/media/SoundChannel.hx",152);
	HX_STACK_THIS(this);
	HX_STACK_LINE(152)
...
Float SoundChannel_obj::get_rightPeak( ){
	HX_STACK_PUSH("SoundChannel::get_rightPeak","flash/media/SoundChannel.hx",151);
	HX_STACK_THIS(this);
	HX_STACK_LINE(151)
...
Float SoundChannel_obj::get_leftPeak( ){
	HX_STACK_PUSH("SoundChannel::get_leftPeak","flash/media/SoundChannel.hx",150);
	HX_STACK_THIS(this);
	HX_STACK_LINE(150)
...
bool SoundChannel_obj::__completePending( ){
	HX_STACK_PUSH("SoundChannel::__completePending","flash/media/SoundChannel.hx",119);
	HX_STACK_LINE(119)
...
{
		HX_STACK_PUSH("SoundChannel::__pollComplete","flash/media/SoundChannel.hx",126);
		HX_STACK_LINE(128)
