...
bool InteractiveObject_obj::__dismissSoftKeyboard( ){
	...
	HX_STACK_THIS(this);
	HX_STACK_LINE(28)
	return ::flash::display::InteractiveObject_obj::nme_display_object_dismiss_soft_keyboard(this->__handle);
}
...
Dynamic InteractiveObject_obj::nme_display_object_dismiss_soft_keyboard;
...
Dynamic InteractiveObject_obj::__Field(const ::String &inName,bool inCallProp)
{
	...
	case 36:
		...
		break;
	case 40:
		if (HX_FIELD_EQ(inName,"nme_display_object_dismiss_soft_keyboard") ) { return nme_display_object_dismiss_soft_keyboard; }
...
Dynamic InteractiveObject_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 36:
		...
		break;
	case 40:
		if (HX_FIELD_EQ(inName,"nme_display_object_dismiss_soft_keyboard") ) { nme_display_object_dismiss_soft_keyboard=inValue.Cast< Dynamic >(); return inValue; }
...
static void sMarkStatics(HX_MARK_PARAMS) {
	...
	HX_MARK_MEMBER_NAME(InteractiveObject_obj::nme_display_object_dismiss_soft_keyboard,"nme_display_object_dismiss_soft_keyboard");
...
static void sVisitStatics(HX_VISIT_PARAMS) {
	...
	HX_VISIT_MEMBER_NAME(InteractiveObject_obj::nme_display_object_dismiss_soft_keyboard,"nme_display_object_dismiss_soft_keyboard");
...
void InteractiveObject_obj::__boot()
{
	...
	nme_display_object_dismiss_soft_keyboard= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_display_object_dismiss_soft_keyboard"),(int)1);
