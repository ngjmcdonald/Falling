		...
		if (((this->active != value))){
			...
			if ((value)){
				...
				if (((bool((focus->__get((int)0).StaticCast< ::flash::display::InteractiveObject >() != null())) && bool(focus->__get((int)0).StaticCast< ::flash::display::InteractiveObject >()->get_needsSoftKeyboard())))){
					...
					Void run(){
						HX_STACK_PUSH("*::_Function_4_1","flash/display/Stage.hx",993);
						{
							HX_STACK_LINE(993)
...
{
		HX_STACK_PUSH("Stage::dummyTrace","flash/display/Stage.hx",308);
		HX_STACK_THIS(this);
		HX_STACK_LINE(308)
		::haxe::Log_obj::trace(HX_CSTRING(""),hx::SourceInfo(HX_CSTRING("Stage.hx"),308,HX_CSTRING("flash.display.Stage"),HX_CSTRING("dummyTrace")));
	}
return null();
}
